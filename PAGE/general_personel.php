...
$user_type = $_SESSION['user']['pers_type']; // Assurez-vous que le type d'utilisateur est stocké ici
$type = 'personel';
...
<body>
    ...
    <div class="sidebar">
       ...
       <a href=""><i class="fas fa-user-shield"></i> DISCUSSION DU PERSONEL</a>
...
<form action="general_personel.php" method="post" enctype="multipart/form-data">
...
?>
    ...
    <form action="general_personel.php" method="post">
        ...
        <a href="personel.php">Retour à mon profil</a> | <a href="logout.html">Se déconnecter</a>
    </div>
    ...
    <div class="online-friends">
        ...
        $sql = "SELECT Nom_famille, Prenom, photo_profil FROM personel ORDER BY pers_id ASC";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
        $result = $stmt->get_result();
