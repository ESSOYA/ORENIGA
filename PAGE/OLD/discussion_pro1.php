...
$user_id = $_SESSION['user']['etu_id']; // ID de l'utilisateur entreprise
$user_type = $_SESSION['user']['etu_type']; // Assurez-vous que le type d'utilisateur est 'entreprise'
$type = 'etudiant';
...
<body>
    <div class="container">
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            ...
            <div class="profil" ><img src="<?php echo htmlspecialchars($row['sender_photo']); ?>" alt="Photo de profil"></div>
                <div class="message-content">
                    ...
                    <form action="discussion_pro1.php" method="post">
        ...
        <a href="etudiant.php">Retour à mon profil</a> | <a href="logout.php">Se déconnecter</a>
    </div>
