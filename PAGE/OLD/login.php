...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($inputUsername) || empty($inputPassword)) {
        ...
        $tables = [
            ['table' => 'etudiants', 'id_field' => 'etu_id', 'redirect' => 'etudiant.php'],
            ['table' => 'enseignants', 'id_field' => 'ens_id', 'redirect' => 'ens.php'],
            ['table' => 'entreprises', 'id_field' => 'entre_id', 'redirect' => 'entre.php'],
            ['table' => 'administrateur', 'id_field' => 'admin_id', 'redirect' => 'administrateur.php']
        ];

        foreach ($tables as $userTable) {
            $sql = "SELECT * FROM {$userTable['table']} WHERE username='$inputUsername'";
...
<body>
    <div class="login-card">
        ...
        <form action="login.php" method="POST" class="sign-in-form" onsubmit="submitForm(event)">
            <input type="text" placeholder="Nom d'Utilisateur" required id="username" name="username">
