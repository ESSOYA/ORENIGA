...
$sql = "SELECT Nom_famille, prénom, username,genre,  DATE_NAISSANCE, email,téléphone ,photo_profil, admin_type FROM administrateur WHERE admin_id = ?"; 
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $profile_id);
$stmt->execute();
$stmt->bind_result($nom, $prenom, $username, $genre, $date_naissance, $email, $phone, $photo_profil, $admin_type);
$stmt->fetch();
$stmt->close();
