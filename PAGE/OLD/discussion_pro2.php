...
<body>
    <div class="container">
        ...
        <form action="discussion_pro2.php" method="post" enctype="multipart/form-data">
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <div class="message">
                ...
                <div class="message-content">
                    ...
                    <form action="discussion_pro2.php" method="post">
        ...
        <a href="entre.php">Retour à mon profil</a> | <a href="logout.php">Se déconnecter</a>
    </div>
