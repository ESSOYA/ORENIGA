...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM enseignants WHERE ens_id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE enseignants SET prénom=?, Nom_famille=?, username=?, email=?, téléphone=?, DATE_NAISSANCE=?, genre=?, ens_type=?, mot_de_passe=?, photo_profil=? WHERE ens_id=?";
...
<img src="IMAGE/ORENIGA_FULL.png" alt="ORENIGA" class="floating-logo">
    ...
    <div class="input-group">
        <select id="gender" name="gender" required>
            ...
            <option value="Other" <?php echo ($user['genre'] === 'Other') ? 'selected' : ''; ?>>AUTRES</option>
        </select>
