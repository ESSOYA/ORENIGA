...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM etudiants WHERE etu_id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE etudiants SET prénom=?, Nom_famille=?, username=?, email=?, téléphone=?, DATE_NAISSANCE=?, genre=?, etu_type=?, mot_de_passe=?, photo_profil=? WHERE etu_id=?";
...
<img src="IMAGE/ORENIGA_FULL.png" alt="ORENIGA" class="floating-logo">
    ...
    <div class="input-group">
        <select id="gender" name="gender" required>
            ...
            <option value="Other" <?php echo ($user['genre'] === 'Other') ? 'selected' : ''; ?>>WOUBI</option>
        </select>
        <select id="role" name="role" required>
            
            <option value="ETUDIANT" <?php echo ($user['etu_type'] === 'ETUDIANT') ? 'selected' : ''; ?>>ETUDIANT</option>
