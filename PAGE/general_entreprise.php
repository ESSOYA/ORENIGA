...
$user_type = $_SESSION['user']['entre_type']; // Assurez-vous que le type d'utilisateur est stocké ici
$type = 'entreprise';
...
<body>
    ...
    <div class="sidebar">
       ...
       <a href="entreprise.html"><i class="fa fa-user"></i> Retour au profil</a>
...
<form action="general_entreprise.php" method="post" enctype="multipart/form-data">
...
?>
    ...
    <form action="general_entreprise.php" method="post">
        ...
        <a href="entreprise.html">Retour à mon profil</a> | <a href="logout.html">Se déconnecter</a>
    </div>
    ...
    <div class="online-friends">
        ...
        $sql = "SELECT Nom_famille, Prenom, photo_profil FROM entreprise ORDER BY entre_id ASC";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
        $result = $stmt->get_result();
