...
$sql = "SELECT Nom_famille, prénom, username,genre,  DATE_NAISSANCE, email,téléphone ,photo_profil, ens_type FROM enseignants WHERE ens_id = ?"; 
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $profile_id);
$stmt->execute();
$stmt->bind_result($nom, $prenom, $username, $genre, $date_naissance, $email, $phone, $photo_profil, $ens_type);
$stmt->fetch();
$stmt->close();
...
<div class="profile-container">
    ...
    <a href="#profil"><img src="<?php echo htmlspecialchars($photo_profil); ?>"  alt="Photo de profil"></a>
        ...
        <h2></h2>
        <strong><p><?php echo htmlspecialchars($ens_type);?></p></strong>
    </div>
    ...
    <div class="profile-section">
        <h3>À Propos</h3>
        <p><strong>Je suis enseignant, et c'est une vocation qui me passionne profondément. Transmettre mes connaissances et voir mes étudiants progresser est pour moi une immense satisfaction. J'aime créer un environnement d'apprentissage stimulant, où chacun peut s'exprimer et développer ses compétences. Chaque jour en classe m'apporte de nouvelles perspectives, et c'est un privilège de participer à la formation des futures générations. Enseigner, c'est aussi apprendre, et je trouve une grande richesse dans ces échanges et dans l'accompagnement de mes étudiants sur leur parcours académique.</strong></p>
    </div>
