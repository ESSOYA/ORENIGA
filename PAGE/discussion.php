...
$user_type = $_SESSION['user']['admin_type']; // Assurez-vous que le type d'utilisateur est stocké ici
$type = 'administrateur';
...
<body>
    ...
    <div class="sidebar">
       ...
       <a href="charge.html"><i class="fa fa-user"></i> Retour au profil</a>
       <a href=""><i class="fa fa-user-graduate"></i> espace etudiant</a>
       <a href=""><i class="fas fa-chalkboard-teacher"></i> espace enseignant</a>
       <a href=""><i class="fa fa-building"></i> espace entreprise</a>
       <a href=""><i class="fas fa-user-shield"></i> espace personel</a>
...
<form action="discussion.php" method="post" enctype="multipart/form-data">
...
?>
    ...
    <div class="mess"><?php echo htmlspecialchars($row['message']); ?></div><br><br>
    ...
    <form action="discussion.php" method="post">
                ...
                $sql_responses = "SELECT r.reponse, r.created_at, r.sender_id, r.sender_type,
                                    CASE 
                                        ...
                                        WHEN r.sender_type = 'administrateur' THEN (SELECT CONCAT(Nom_famille, ' ', Prenom) FROM administrateur WHERE admin_id = r.sender_id)
                                         WHEN r.sender_type = 'personel' THEN (SELECT CONCAT(Nom_famille, ' ', Prenom) FROM personel WHERE pers_id = r.sender_id)
        ...
        <a href="administrateur.php">Retour à mon profil</a> | <a href="logout.html">Se déconnecter</a>
    </div>
    ...
    <div class="online-friends">
        ...
        $sql = "SELECT Nom_famille, Prenom, photo_profil FROM administrateur ORDER BY admin_id ASC";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
