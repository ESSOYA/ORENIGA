...
$user_id = $_SESSION['user']['ens_id'];
$user_type = $_SESSION['user']['ens_type']; // Assurez-vous que le type d'utilisateur est stocké ici
$type = 'enseignant';
...
<body>
    ...
    <div class="sidebar">
       ...
       <a href="enseignant.html"><i class="fa fa-user"></i> Retour au profil</a>
...
<form action="general_enseignant.php" method="post" enctype="multipart/form-data">
...
?>
    ...
    <form action="general_enseignant.php" method="post">
        ...
        <a href="enseignant.html">Retour à mon profil</a> | <a href="logout.html">Se déconnecter</a>
    </div>
    ...
    <div class="online-friends">
        ...
        $sql = "SELECT Nom_famille, Prenom, photo_profil FROM enseignant ORDER BY ens_id ASC";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
        $result = $stmt->get_result();
