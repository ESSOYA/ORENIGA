...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM etudiant WHERE etu_id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE etudiant SET Prenom=?, Nom_famille=?,  Email=?, Téléphone=?, DATE_NAISSANCE=?, Genre=?, etu_type=?, Mot_de_passe=?, Photo_profil=? WHERE etu_id=?";
...
<img src="IMAGE/ORENIGA_FULL.png" alt="ORENIGA" class="floating-logo">
    ...
    <div class="input-group">
        <select id="gender" name="gender" required>
            ...
            <option value="Other" <?php echo ($user['Genre'] === 'AUTRE') ? 'selected' : ''; ?>>AUTRES</option>
        </select>
