...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updateSql = "UPDATE personel SET Prenom=?, Nom_famille=?,  Email=?, Téléphone=?, DATE_NAISSANCE=?, Genre=?, pers_type=?, Mot_de_passe=?, Photo_profil=? WHERE pers_id=?";
...
<img src="IMAGE/ORENIGA_FULL.png" alt="ORENIGA" class="floating-logo">
    ...
    <div class="input-group">
        ...
        <select id="role" name="role" >
            ...
            <option value="personel" <?php echo ($user['pers_type'] === 'personel') ? 'selected' : ''; ?>>personel</option>
